...
namespace Utils
{
	...
	{
#define JetPrinterExc(id, msg) JetPrinterException(id, (const char*)msg, __FILE__, __LINE__, __FUNCTION__)


		class JetPrinterException : public exception
		{
		public:
			JetPrinterException()
				: m_Empty(true)
		...
		public:
			typedef shared_ptr<JetPrinterException> JetPrinterExceptionPtr;
